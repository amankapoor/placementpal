...
// func (u *User) List(ctx context.Context, w http.ResponseWriter, r *http.Request, params web.Params) error {
...
// func (u *User) Retrieve(ctx context.Context, w http.ResponseWriter, r *http.Request, params web.Params) error {
// 	reqDB, err := u.MasterDB.MGOCopy()
// 	if err != nil {
// 		return errors.Wrapf(web.ErrDBNotConfigured, "")
// 	}
...
// func (u *User) Create(ctx context.Context, w http.ResponseWriter, r *http.Request, params web.Params) error {
...
// func (u *User) Update(ctx context.Context, w http.ResponseWriter, r *http.Request, params web.Params) error {
// 	reqDB, err := u.MasterDB.MGOCopy()
// 	if err != nil {
// 		return errors.Wrapf(web.ErrDBNotConfigured, "")
// 	}
...
// // 200 Success, 400 Bad Request, 500 Internal
// func (u *User) Delete(ctx context.Context, w http.ResponseWriter, r *http.Request, params web.Params) error {
// 	reqDB, err := u.MasterDB.MGOCopy()
// 	if err != nil {
// 		return errors.Wrapf(web.ErrDBNotConfigured, "")
// 	}
